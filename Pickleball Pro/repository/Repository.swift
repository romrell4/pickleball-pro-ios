...
protocol Repository {
    ...
    func deleteMatch(match: Match, callback: @escaping (Result<Dictionary<String, String>, AFError>) -> Void)
}
...
class RepositoryImpl: Repository {
    ...
    func deleteMatch(match: Match, callback: @escaping (Result<Dictionary<String, String>, AFError>) -> Void) {
        request(path: "/matches/\(match.id)", method: .delete, callback: callback)
    }
