...
class MatchTest: XCTestCase {
    func testGroupingFiltering() throws {
        let match = Match(
            ...
            scores: [],
            stats: [
                Stat(id: "", playerId: "p1", matchId: "m1", gameIndex: 0, result: .winner, category: .serve, type: .ace),
                Stat(id: "", playerId: "p1", matchId: "m1", gameIndex: 1, result: .winner, category: .serve, type: .ace),
                Stat(id: "", playerId: "p2", matchId: "m1", gameIndex: 0, result: .winner, category: .serve, type: .ace),
                Stat(id: "", playerId: "p3", matchId: "m1", gameIndex: 0, result: .winner, category: .serve, type: .ace),
            ]
        )
